    ...
    public void jugar() {
        ...
        if (getCredito() >= precJug) {
            ...
            for (int i = 0; i < casillas; i++) {
                ...
                frutas[i] = frutasAleatorias[index];
            ...
            for (int i = 0; i <= n; i++) {
                ...
                if (Arrays.equals(frutas, coleccion[i].getCombinacionGanadora().toArray())){
                    credDisp = credDisp + coleccion[i].getPremio() + getCredito();
                    System.out.println("a"+ credDisp);
